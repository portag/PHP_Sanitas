...
<style>
    ...
    .mouse a:hover {
        background: linear-gradient(to top, rgba(0, 123, 255, 0.9), rgba(0, 123, 255, 0.6));
    }
...
<body class="">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="mouse navbar-nav">
                    ...
                    <a class="nav-link active" aria-current="page" href="/citas/pacientes">Tus pacientes</a>



                    @auth
                        <a class="nav-link active" href="/profile">Mi perfil</a>
                    @else
                        <li style="list-style: none">
                            <a id="login-register-button" href="{{ route('login') }}" id="login-register-button">LOGIN</a>
                            @if (Route::has('register'))
                                <a id="login-register-button" href="{{ route('register') }}">SIGN UP</a>
                            @endif
                        </li>
                    @endauth
    ...
    <footer class="footer text-center text-white bg-info">
        <!-- Grid container -->
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2020 Copyright:
            <a class="text-white" href="https://sanitasCorner.com/">SanitasCorner.com</a>
        </div>
        <!-- Copyright -->
    </footer>
