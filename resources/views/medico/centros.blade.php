    ...
    <div class="filtro d-flex justify-content-center">
        <form action="/centros/filtro" class="w-50">
            <div class="d-flex align-items-center">
                ...
                <button class="btn btn-outline-info d-flex" type="submit">Buscar<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
        ...
        @foreach ($centros as $centro)
            <div class="card" style="width: 400px;">
                ...
                <ul class="list-group list-group-flush text-center">
                    ...
                    <li class="list-group-item">
                        <a href="/centros/{{ $centro->id }}" class="btn btn-outline-info">Portal del centro<svg
